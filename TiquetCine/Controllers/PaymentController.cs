...
namespace TiquetCine.Controllers
{
    ...
    {
        private const string _key = "rzp_test_ozFceEMz35kw3U";
        private const string _secret = "hgfvfzhmJmvGGPGgDRT54XiJ";

        public ViewResult Registration()
        {
            var model = new RegistrationModel() { Amount = 1100 };
            return View(model);
        }
        ...
        public ViewResult AfterPayment()
        {
            ...
            if (validSignature)
            {
                ViewBag.Message = "Felicidad!! El pago fue exitoso";
                return View("Success");
            }
            else
            {
