...
namespace TiquetCine.Controllers
{
    public class ActoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ActorId,Foto,Nombre,Biografia")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ActorId,Foto,Nombre,Biografia")] Actor actor)
        {
            if (id != actor.ActorId)
            {
                return NotFound();
